    ...
    <table border="1px">
        ...
        while($info=$result->fetch_assoc())
        {
            ...
            <tr>
                ...
                <td class="table_td"><?php  echo "<a onClick=\" javascript:return confirm ('Do you want to delete this')\"class='btn btn-danger' href='delete.php?student_id={$info['id']}'>Delete </a>"; ?></td>
